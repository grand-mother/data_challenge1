...
#
    file.close()
#    
def CreateTimeWindowInp( xmaxdistance, OutputFile, Tmin=-50.0, Tmax=450.0):
    #   
    file= open(OutputFile, "a")
    #
    file.write('######################################################################################\n')
...
#
# SimParametersFile:
# A file that has all the relevant parameters for a valid the particle simulation, except  RandomSeed, EventName, Primary, Energy, Zenith, Azimuth
...
#
#
def GenerateZHAireSArrayInputFromSry(SryFile, ArrayPositionsFile, CorePosition, ArrayName, SimParametersFile, Tmin=-50,Tmax=450, OutMode="a"):
...
def GenerateEventParametersFile(EventName, Primary, Energy, Zenith, Azimuth, CorePosition, ArrayName, OutMode="a"):
#    
...
if __name__ == '__main__':
  ...
  #
    ...
    cmd='python3 ZHAireSRawToGRANDROOT.py . minimal 0 0 '+EventName+' '+EventName+".root"
    print("about to run",cmd) 
    out = subprocess.check_call(cmd,shell=True)
    #Delete .dat files    
